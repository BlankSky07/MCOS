...
<head>
  <meta charset="UTF-8">
  <title>MC Ordering System - Completed Orders</title>
        ...
        <div class="main-header__intro-wrapper">
          <div class="main-header__welcome">
            ...
            <div class="main-header__welcome-title text-light">
              <strong>Completed</strong> Orders
            </div>
...
<div class="cardo">
  ...
  <div class="cardo">
    ...
    <div class="documents">
      ...
      <table class="table table-bordered" id="CompletedIndexTable" width="100%" cellspacing="0">
        ...
        <tbody>
          ...
          ob_start();
            ...
            $result = $conn->prepare("SELECT tblorders.Order_ID,
                                             ...
                                             tblmc.MC_Lname,
                                             tblgroup.Group_Name,
                                             TIMEDIFF(DATE_FORMAT(tblorders.Order_Served, '%d %H:%i:%s'),DATE_FORMAT(tblorders.Order_Date, '%d %H:%i:%s')) AS Duration
                                      FROM tblorders
