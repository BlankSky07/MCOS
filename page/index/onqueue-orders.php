...
<head>
  <meta charset="UTF-8">
  <title>MC Ordering System - On Queue Orders</title>
        ...
        <div class="main-header__intro-wrapper">
          <div class="main-header__welcome">
            ...
            <div class="main-header__welcome-title text-light" style="padding-bottom:50px;">
              <strong>On-Queue</strong> Order List
            </div>
...
<div class="cardo">
  ...
  <div class="cardo">
    ...
    <div class="documents">
      ...
      <table class="table table-bordered" id="OnQueueIndexTable" width="100%" cellspacing="0">
...
<div class="card-footer small text-muted">Updated today at <?php date_default_timezone_set("Asia/Manila"); echo date("h:i:sa");?>
</div>
