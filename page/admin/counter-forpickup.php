...
<head>
  <meta charset="UTF-8">
  <title>MC Ordering System - Counter (For Pick-Up)</title>
          ...
          <div class="card-header">
              ...
              <tbody>
                ...
                $result = $conn->prepare("SELECT tblorders.Order_ID,
                                          ...
                                          WHERE tblorders.OrderStatus_ID = 3
                ...
                $result->execute();
                  ...
                  for($i=0; $row = $result->fetch(); $i++){ ?>
                    ...
                    <tr>
                      ...
                      <td><table class="table table-bordered" width="100%" cellspacing="0">
                        ...
                        <tbody>
                          ...
                          <tr><!-- ########################ITEM 3 ACTION####################### -->
                            <td id="ItemOrderID"><?php echo $row['Order_ID'];?></td>
                            <td><?php echo $row['Item1'];?></td><!-- #######ITEM 3 NAME######## -->
                            <td><?php echo $row['Desc1'];?></td><!-- #######ITEM 3 DESC######## -->
                            <td><?php echo $row['Qty1'];?></td><!--  #######ITEM 3 QTY######### -->
                            <td><?php echo $row['ServedQty1'];?></td><!-- ##ITEM 1 SERVED QTY## -->
                            <td><!-- #######################ITEM 3 STATUS###################### -->
                              <?php if($row['Stat1'] == 'N/A'){
                                        echo 'N/A';
                                      } 
                          ...
                          <tr><!-- ########################ITEM 2 ACTION####################### -->
                            ...
                            <td><?php echo $row['ServedQty2'];?></td><!-- ##ITEM 2 SERVED QTY## -->
                          ...
                          <tr><!--#######################ITEM 3 ACTION########################-->
                            ...
                            <td><?php echo $row['ServedQty3'];?></td><!---ITEM 3 SERVED QTY######-->
                          ...
                          <tr><!--######ITEM 4######-->
                            ...
                            <td><?php echo $row['ServedQty4'];?></td><!---ITEM 4 SERVED QTY######-->
                          ...
                          <tr><!--######ITEM 5######-->
                            ...
                            <td><?php echo $row['ServedQty5'];?></td><!---ITEM 5 SERVED QTY######-->
                    ...
                    <td><input type="number" id="ReceiverCID"></td>
                    <td><button class="btn btn-teal" type="button" id="btnOrderServed">Order Served</button></td>
